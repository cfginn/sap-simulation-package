...
class Dirty_rat(Animal):
  ...
  def __init__(self, addAttack = 0, addHealth = 0):
    ...
    super().__init__(addAttack + self.BASE_ATTACK, addHealth + self.BASE_HEALTH, animalType = constants.DIRTY_RAT, tier = Summoned, ability=self.ability)
