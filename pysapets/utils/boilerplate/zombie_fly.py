...
class Zombie_fly(Animal):
  ...
  def __init__(self, addAttack = 0, addHealth = 0):
    ...
    super().__init__(addAttack + self.BASE_ATTACK, addHealth + self.BASE_HEALTH, animalType = constants.ZOMBIE_FLY, tier = Summoned, ability=self.ability)
